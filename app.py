...
class BTCHousingModel:
    ...
    def scenario_a_sell_btc(self):
        ...
        final_btc_value = self.B0 * self.P0 * (1 + self.rb) ** self.T  # Opportunity cost if held
    ...
    def scenario_c_btc_collateral(self, btc_rate=None, house_rate=None, num_paths=100):
    ...
    def simulate_scenarios(self, num_simulations=500):
        ...
        for _ in range(num_simulations):
            ...
            result_c = self.scenario_c_btc_collateral(btc_rate=btc_rate, house_rate=house_rate, num_paths=1)
...
with tab3:
    ...
    with st.expander("Sensitivity Analysis"):
        ...
        for rate in btc_rates:
            ...
            c = temp_model.scenario_c_btc_collateral(btc_rate=rate)
